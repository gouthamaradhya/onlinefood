...
<body class="home">
        ...
        <section class="hero bg-image" data-image-src="images/img/pimg.jpg">
            <div class="hero-inner">
                ...
                <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/bmsit.png" width="100" height="100" alt=""> </a>
                    <h1>BMSIT COLLEGE RESTAURANT</h1>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>BMSIT College, Avalahalli, Yelahanka</p>
